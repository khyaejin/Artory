...
export const Stories = [
    {
        ...
        "키워드": ["# 황성욱", "# 개인전", "# 실물영접"],
        "글내용": [
            { "type": "text", "content": "오늘은 드디어 꼭 가고 싶던..요시다 유니 작가님의 개인전을 보러 갔다!!!!!!!석파정 미술관이 그리 멀지 않아 금방 다녀올 수 있었는데.. 사실 친구랑 같이 볼러 간건데,, 지각한 친구덕분에 쫌 천천히 들어감ㅋㅋㅋ암튼 팜플렛에 있는 간단한 전시 소개라도 보금 보면서 친구를 기다리고 얼마 안있어서 들어갔습니답" },
